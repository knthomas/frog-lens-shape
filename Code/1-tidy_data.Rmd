...
#add synonym and substitutions for phylogeny into dataframe (phylo_species column)
adult_eye$phylo_species <- as.character(adult_eye$genus_species)
adult_eye[adult_eye$phylo_species=="Hypsiboas_geographica", "phylo_species"] <- "Hypsiboas_geographicus"
adult_eye[adult_eye$phylo_species=="Chiasmocleis_hudsoni", "phylo_species"] <- "Syncope_hudsoni"
adult_eye[adult_eye$phylo_species=="Rhombophryne_nilevina", "phylo_species"] <- "Rhombophryne_alluaudi"
